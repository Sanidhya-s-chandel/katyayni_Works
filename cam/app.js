...
app.get('/start-recording', (req, res) => {
  if (!ffmpegProcess) {
    const outputFilePath = path.join(recordingsFolder, 'output_video.mkv'); // Output file path

    // Replace 'USB Camera' with the name of your USB camera from ffmpeg -list_devices command
    ...
    ffmpegProcess = ffmpeg()
      ...
      .audioCodec('aac') // AAC codec for audio (if the camera has audio input)
